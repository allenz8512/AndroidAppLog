...
public class Utils {
     ...
     * 
     * @param str String
     * @return if the string is {@code null} or length equals 0 return true,otherwise return false;
     * @since 0.1.0-RELEASE
     */
     ...
     * 
     * @param classFullName fullname(with package) of the class
     * @param tag tag in configure
    ...
    /**
     * A method like {@link Boolean#parseBoolean(String)}, but return {@code null} when the string can not be parsed
     * boolean.
     * 
     * @param str String
     ...
     * 
     * @param className the fullname of the class
     * @param fieldName the name of the field
     * @param defaultValue the default value to return when failed to get value of the field
     * @return the value of the field when successed, or the default value when failure
     * @since 0.1.0-RELEASE
     */
