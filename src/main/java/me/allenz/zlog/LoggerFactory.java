...
public class LoggerFactory {
     ...
     * Initialize zlog.
     * 
     * @param context the applicationContext of the app
     * @since 0.1.0-RELEASE
     */
     ...
     * 
     * @param context the applicationContext of the app
     * @param releaseRootLoggerLevel log level of the root logger in release mode
     * @since 0.2.0-RELEASE
     */
    public static void init(final Context context,
    ...
    /**
     * Read the value of 'package.BuildConfig.DEBUG', this value is {@code true} in developing and is {@code false}
     * after being packaged(release mode). In generally, we want to hide the low level log message in release mode.
     * 
    ...
    private static Logger getNewLogger(final String caller) {
        ...
        if (loggerConfig != null) {
            logger = createNewLogger(caller, loggerConfig);
        } else {
    ...
    private static Logger createNewLogger(final String caller,
        ...
        final String tag = loggerConfig.getTag() == null? className
            : loggerConfig.getTag();
        final Logger logger = new TextViewLogger(caller, tag,
