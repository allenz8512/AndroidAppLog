...
public class LoggerFactory {
    ...
    private static void checkBuildConfigAndApplyConfigure() {
        final boolean underDevelopment = ReflectUtils.booleanReflectStaticFieldValue(
            packageName +
    ...
    private static Logger createAppenderSupportLogger(final String caller,
        ...
        final String tag = loggerConfig.getTag() == null? className
            : loggerConfig.getTag();
        final Logger logger =
            new AppenderSupportLogger(className, loggerConfig.getLevel(), tag, loggerConfig.isShowThreadName());
